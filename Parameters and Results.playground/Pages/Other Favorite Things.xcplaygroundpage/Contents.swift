 ...
 */
let categoryOfThing = "bebida"
let favorite = "cerveja"


func printFavorite(categoria: String, objeto: String) {
    print("My favorite \(categoria) is \(objeto)")
}

printFavorite(categoria: categoryOfThing, objeto: favorite)
/*:
