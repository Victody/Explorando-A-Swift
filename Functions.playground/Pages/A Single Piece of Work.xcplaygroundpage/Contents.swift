 ...
 */
let arrayDaLetra = ["Diga onde você vai", "Que eu vo varreno", "Diga onde você vai", "Que eu vo varreno", "vo varreno", "vo varreno", "vo varreno", "vo varreno", "vo varreno", "vo varreno", "vo varreno", "vo varreno", "O menininha eu sou seu fã", "O menininha eu sou seu fã", "Danço contigo até de manhã", "danço contigo até de manhã"]

escreveMusica(arrayDaLetra: arrayDaLetra)

func escreveMusica(arrayDaLetra: Array<Any>){
    var indexCount = 0
    while indexCount < arrayDaLetra.count {
        print(arrayDaLetra[indexCount])
        indexCount += 1
    }
