 ...
 */
var totalChocolate = Int()
var totalBeach = Int()
for voto in tripDestinationVotes{
    switch voto {
...
if totalBeach > totalChocolate {
    print("Estudantes preferem a praia")
} else if totalChocolate > totalBeach{
    print("Estudantes preferem a fábrica de chocolates")
} else {
    print("Empate, recomenda-se novo pleito")
}
/*:
### Extension:
...
var totalSalamander = Int()
var totalMarmoth = Int()
var totalNeither = Int()

for voto in mascotVotes{
    switch voto {
    case .salamander:
        totalSalamander += 1
    case .marmot:
...
if totalSalamander > totalMarmoth {
    print("Estudantes preferem a Salamandra")
} else if totalMarmoth > totalSalamander{
    print("Estudantes preferem a Marmota")
} else {
    print("Não há decisão, recomenda-se novo pleito")
}
